...
export default function KnowledgeClient() {
    const { data: items, isLoading, error } = useContentList("knowledgeItem");
        ...
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    const studioUrl = `/studio/structure/knowledgeBase;${item._id}`;
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <DataTable
                ...
                showAddButton={true}
                onAdd={() => window.open("/studio/structure/knowledgeBase", "_blank")}
